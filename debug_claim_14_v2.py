...
def check_claim_14():
    try:
        ...
        if claim:
            ...
            print("\n--- Claim 14 Lines ---")
            cur.execute("SELECT id, service_code, service_name, applied_category_id, approved_unit_price, approved_quantity, total_price, rejected FROM claim_lines WHERE claim_id = 14")
