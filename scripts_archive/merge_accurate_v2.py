...
# Final global deduplication by name just in case two files had same names but different f_num (e.g. typos in f_num)
...
output_path = r'd:\tba_waad_system-main\tba_waad_system-main\جليانة_الدقيقة.xlsx'
...
wb.save(output_path)
print(f"SUCCESS: جليانة_الدقيقة.xlsx generated accurately with {len(final_df)} rows based purely on Financial Numbers.")
